...
//    List<Map<String,dynamic>> _notes = NoteInheritedWidget.of(context).notes;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
                      ...
                      onPressed: () {
                        ...
                        if (EditMode.Adding == args.editmode) {
                          ...
                          String formatteddate =
                              DateFormat('dd MMM yyyy, HH:mm').format(timenow);
                          DBHelper.insertNote({
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Container(
                  child: Text(
                    EditMode.Adding == args.editmode
                        ? formatteddate
                        : args.map['time'],
                    style: TextStyle(
                        color: Colors.black45, fontFamily: 'RobotoMonoRegular'),
                  ),
                )
              ],
            ),
            TextFormField(
              ...
              style: TextStyle(fontFamily: 'RobotoMonoRegular', fontSize: 15),
        ...
        floatingActionButton: SpeedButton(
            map: args.map,
    ...
    if (editmode == EditMode.Adding) {
      if (SaveAdd.save) {
        ...
        if (checkspace == '') {
          ...
          DBHelper.updateNote({'id': id, 'fav': Fav.favintfavonly()});
        }
      }
