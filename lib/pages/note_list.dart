                    ...
                    return ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Card(
                            ...
                            color:   Color.fromRGBO(236, 224, 225, 1),// Colors.brown[100],
                            elevation: 0.0,
                            child: Dismissible(
                              ...
                              confirmDismiss: (direction) async {
                                ...
                                if (direction==DismissDirection.startToEnd) {
                                  final action = await Dialogs.deleteDialog(context, 'Warning!', "The note cannot be retrieved once it's deleted.");
                              ...
                              child: ListTile(
                                onTap: () async {
                                  final map = await DBHelper.getNote(notes[index]['id']) ;
                                  Passing.map = map;
                                ...
                                trailing: BlinkStar(notes[index]['fav'] == 1, notes[index])
                              ),
                            ),
                          );
                        }
            ...
            floatingActionButton: Opacity(
              ...
              child: FloatingActionButton(
                  onPressed: () {
                    ...
                    Navigator.pushNamed(
                        context, '/edit', arguments: PassArguments(editmode: EditMode.Adding));
                  },
                  elevation: 3,
